...
public class LocalVirtualMachine
{
    ...
    public boolean isManageable() { return (address != null); }
    public boolean isJ9Mode() { return J9Mode; }
    ...
    public String connectorAddress() { return address; }

    public String displayName() { return displayName; }

    @Override
    public String toString() { return commandLine; }
    ...
    public static LocalVirtualMachine getLocalVirtualMachine(int vmid) throws Exception {
    ...
    public static LocalVirtualMachine getDelegateMachine(VirtualMachine vm) throws IOException {
        // privileges.
        ...
        vm.detach();
        return new LocalVirtualMachine(Integer.parseInt(vm.id()), name, true, address);
    }
